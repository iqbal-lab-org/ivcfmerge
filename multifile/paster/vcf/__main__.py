...
def main():
    ...
    parser.add_argument('-p', '--n-processes', type=int, default=1, help="number of processes to use")
    args = parser.parse_args()

    paster = VCFPaster(args.input_paths, args.output_path, args.delimeter, args.batch_size,
                        args.n_header_lines, args.n_fixed_cols, args.temp_dir_path, args.n_processes)
    paster.paste()
