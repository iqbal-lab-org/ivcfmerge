...
class VCFPaster:
    def __init__(self, input_paths, output_path, delimeter='\t', batch_size=1, n_header_lines=11, n_fixed_cols=9, n_samples_each=1):
    ...
    def paste(self):
        return naive_paste_incremental(
            self._input_paths, self._output_path, self._delimeter, self._batch_size,
            n_header_lines=self._n_header_lines, cell_preprocessor=self._strip_fixed_cols_from_line)
