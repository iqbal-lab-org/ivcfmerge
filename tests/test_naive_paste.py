...
def test_naive_paste():
    ...
    naive_paste(input_paths, output_file.name)
...
def test_naive_paste_with_one_input_file():
    ...
    naive_paste([test_file], output_file.name)
...
def test_naive_paste_skipped_headers():
    ...
    naive_paste(input_paths, output_file.name, from_line=11)
...
def test_naive_paste_proper_headers():
    ...
    naive_paste(input_paths, output_file.name, n_header_lines=11)
